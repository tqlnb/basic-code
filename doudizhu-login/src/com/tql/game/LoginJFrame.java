...
import com.tql.domain.User;
import com.tql.util.CodeUtil;
...
public class LoginJFrame extends JFrame implements MouseListener {
	...
	*/
    ...
    public void initView() {
        ...
        login.setIcon(new ImageIcon("doudizhu-login\\image\\login\\登录按钮.png"));
        //去除按钮的边框
        ...
        register.setIcon(new ImageIcon("doudizhu-login\\image\\login\\注册按钮.png"));
        //去除按钮的边框
        ...
        //7.添加背景图片
        JLabel background = new JLabel(new ImageIcon("doudizhu-login\\image\\login\\background.png"));
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if(username.getText().length() == 0 || Arrays.toString(password.getPassword()).length() == 0){
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getSource() == login) {
            login.setIcon(new ImageIcon("doudizhu-login\\image\\login\\登录按下.png"));
        } else if (e.getSource() == register) {
            register.setIcon(new ImageIcon("doudizhu-login\\image\\login\\注册按下.png"));
        }
    }
